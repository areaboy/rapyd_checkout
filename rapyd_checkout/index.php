...
<div class="modal fade" id="myModal_checkout_notify_full">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal Header -->
      <div class="modal-header">
        <h4 class="modal-title">Abandon Carts Notification Triggers</h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
...
<div class="modal fade" id="myModal_checkout_notify_empty">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal Header -->
      <div class="modal-header">
        <h4 class="modal-title"> Empty Carts Notification Triggers</h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
...
/<li class="nav-item">
                            <a <a style='cursor:pointer;' class="nav-link" data-bs-toggle="modal" data-bs-target="#myModal_about" title="About">About</a>
                        </li>/
                        <li class="nav-item">
                            <a style='cursor:pointer;' class="nav-link" data-bs-toggle="modal" data-bs-target="#myModal_contact" title="Contact-Us">ContactUs</a>
                        </li>/

<li class="nav-item">

                            <a style='cursor:pointer;' class="nav-link" data-bs-toggle="modal" data-bs-target="#myModal_signup_admin" title="Admin Signup">Admin Signup</a>
                        </li>/
                        <li class="nav-item">

                            <a style='cursor:pointer;' class="nav-link" data-bs-toggle="modal" data-bs-target="#myModal_login_admin" title="Admin Login">Admin Login</a>
                        </li>/
                        
                        <li class="nav-item">

   <a style='cursor:pointer;' class="nav-link" data-bs-toggle="modal" data-bs-target="#myModal_signup_customer" title="Customer Login">Customer Signup</a>
                        </li>/

<li class="nav-item">

   <a style='cursor:pointer;' class="nav-link" data-bs-toggle="modal" data-bs-target="#myModal_login_customer" title="Customer Login">Customer Login</a>
                        </li>/
...
<h2><center>Introducing Single Page E-Commerce Checkout Powered by Rapyd & Email Clients. </center></h2>
<b><center>
    Easily Create More Sales Conversions,  Manage Abandon Carts, Manage Saved Carts, Sales and Payments..</center>
</b>



<?php
$file_e = 'mail_vendor/autoload.php';
        if (file_exists($file_e)) {
            //echo "The file $file_e exists";
        }else {
            echo "<div style='background:red;color:white;padding:20px;'>It seems you are using our Github Clone. Github web Interface File uploader allows maximum of just 100 files uploads at ago so we have have to split our code  into two parts for easier upload. <br><br> Note that <b>Mail_Vendor</b> Directory is missing in your application Source Code. You will need to Download it Here and Unzip it directly inside the main application source code folder<b>(rapyd_checkout/)</b> and everything will be fine. Finally you will have <b>(rapyd_checkout/mail_vendor)</b><br><br>  <a style='color:white;' href='http://fredjarsoft.com/mail_vendor.zip'>Click here to Download It.</b></div>";
            exit();
        }
        ?>
...
if($nosofrows == 0){
echo "<br><br><br><br><div style='background:red;color:white;padding:10px;'>No Products Added yet.. Please Login as Admin to Add Products/Items</div>";
//exit();
}
...
max-width:450px;max-height:350px;' src='uploads/<?php echo $photo; ?>' title='Image'><br>
<b>Products Sales Shareable Link: </b>  <a href='https://<?php echo $site_url; ?>/product_share.php?id=<?php echo $timing;?>'>https://<?php echo $site_url; ?>/product_share.php?id=<?php echo $timing;?></a>
                </div>
                <div class="col-md">
 ...
 <div style='display:none' class="alert alert-info" role="alert">
	...
	<button title="Buy Now via Login" data-bs-toggle="modal" data-bs-target="#myModal_buy_login" class="btn col-sm-5 loginx_css  btn_action_buy_login" 
...
data-total_payments="<?php echo $total_payments; ?>"  data-description="<?php echo $description; ?>" data-identity="<?php echo $timing; ?>"  data-shipping_rate="<?php echo $shipping_rate; ?>">
	    Buy Now
	    <br>
<span style='font-size:12px;'>Via Customer Login</span></button>
...
<span style='font-size:14px;'>OR</span>
	...
	<button title="Buy Now via Guest Checkout" data-bs-toggle="modal" data-bs-target="#myModal_buy" class="btn col-sm-5 guest_css  btn_action_buy" 
data-id="<?php echo $id; ?>" data-photo="<?php echo $photo; ?>" data-title="<?php echo $title; ?>" data-price="<?php echo $price; ?>" 
data-total_payments="<?php echo $total_payments; ?>"  data-description="<?php echo $description; ?>" data-identity="<?php echo $timing; ?>"  data-shipping_rate="<?php echo $shipping_rate; ?>">
	    Buy Now
	    <br>
<span style='font-size:12px;'>Via Guest Checkout</span></button>
...
<div class="modal fade" id="myModal_buy" >
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <!-- Modal Header -->
      <div class="modal-header">
        <h4 class="modal-title"><span class='p_title'></span> ------ Guest Checkout</h4>
