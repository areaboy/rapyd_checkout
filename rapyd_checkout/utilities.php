...
function make_request($method, $path, $body = null) {
 ...
 include('rapdy_access_keys.php');
    $base_url = $rapyd_base_url;      //Rapyd base url

 $access_key = $access_key_call;     // The access key received from Rapyd.
 $secret_key = $secret_key_call;     // Never transmit the secret key by itself.
