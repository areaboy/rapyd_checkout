...
$("#loader-load-updates_email").fadeIn(400).html('<br><br><div style="color:white;background:#800000;padding:10px;"><img src="loader.gif">&nbsp;Please Wait, Sending You Payments Emails Updates</div>');
