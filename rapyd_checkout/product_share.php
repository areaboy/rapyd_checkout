...
<h2><center>Introducing Single Page E-Commerce Checkout Powered by Rapyd. </center></h2>
...
if($nosofrows == 0){
echo "<br><br><br><br><div style='background:red;color:white;padding:10px;'>This Product Does not Exist</div>";
//exit();
}
