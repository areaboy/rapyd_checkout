...
$email_subject = "Your Saved Cart Checkout Payments Reminder";
$email_message="$email_reminder <br>Please Click Link Below to complete your Checkout Payments. Thanks.<br> <br>
<a style='color:white;background:green;padding:6px;' href='$site_url/checkout_abandon_cart.php?cart_id=$cart_session'>Continue with Your Saved Cart Checkout</a><br><br>
