...
$sender_name= "Purchase by $fullname";
$recipient_name = $company_name;
$recipient_email = $company_email;
$title_product = "You have New Products Sales ---$tx";
$email_subject = $title_product;

		    

$messaging = "
Hi Seller! <b>$recipient_name</b>, <span style='color:green'>You have a new Products Sales from $sender_name.</span><br>
<br>

<h3>About Your Customers Rapyd Payments</h3>
...
<h3>About Your Customers Rapyd Products</h3>
...
<h3>About Your Customers Shipping Details</h3>
...
if(!$sent) 
{
echo "<div style='background:red;color:white;padding:8px;border:none;'>Sales Email Message not sent to Seller. Ensure Internet Connection.  Error: {$mail->ErrorInfo}</div>";

echo "<script>alert('Email not Sent. Ensure Internet Connection.');</script>";
} 
else 
{
echo "<script>alert('Sales Email successfully sent to your Seller Inbox or Spambox.');
$('#myModal_social').modal('show');
</script>";
  echo "<br><div style='background:green;color:white;padding:8px;border:none;'>Sales Email successfully sent to your Seller  Inbox or Spambox.</div>";
