...
$pay_url_value = strip_tags($_POST['pay_url_value']);
...
$email_subject = "Your Payments URL Completion Reminder";
$email_message="$email_reminder <br>Please Click Link Below to complete your Payments. Thanks.<br> <br>
<a style='color:white;background:green;padding:6px;' href='$pay_url_value'>Continue with Your Payments</a><br><br>
