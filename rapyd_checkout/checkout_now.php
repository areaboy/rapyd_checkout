...
$cus_login_track = $_SESSION['cus_login_track'];
...
echo "<div style='background:red;color:white;padding:10px;border:none'>Error: Cart Session  and CartId does not Match. Direct Page Access Not Allowed... <br><a style='background:navy;color:white;padding:8px;border:none;' href='index.php'>Home</a></div>";
exit();
...
<h4><center>Your Shopping Cart Rapyd Payments System</center></h4>
...
$("#loader-load-updates_email").fadeIn(400).html('<br><br><div style="color:white;background:#800000;padding:10px;"><img src="loader.gif">&nbsp;Please Wait, Sending Your Items and Payments to Email</div>');
...
if(cltx == ''){
  ...
  // $('#myModal_create_account').modal('show');
