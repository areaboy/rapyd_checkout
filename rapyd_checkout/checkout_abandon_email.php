...
$email_subject = "Your Abandoned Cart Checkout Payments Reminder";
$email_message="$email_reminder <br>Please Click Link Below to complete your Checkout Payments. Thanks.<br> <br>
<a style='color:white;background:green;padding:6px;' href='$site_url/checkout_abandon_cart_checkout.php?cart_id=$cart_session'>Continue with Checkout & Payments</a><br><br>
